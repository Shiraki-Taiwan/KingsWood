		...
		<tr>
			<td style="background-color: #c9e0f8;">
				...
				<table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
					<tr>
						<th style="min-width: 200px">帳　　號：</th>
						<td>
...
%>
							...
							<input type="radio" name="GroupType" value="2" style="border-style: solid; border-color: #C9E0F8" />攬貨商
...
%>
							<input type="radio" name="GroupType" value="1" style="border-style: solid; border-color: #C9E0F8" />管理者
							<input checked type="radio" name="GroupType" value="2" style="border-style: solid; border-color: #C9E0F8" />攬貨商
							<input type="radio" name="GroupType" value="3" style="border-style: solid; border-color: #C9E0F8" />檢視人員
<%
       	                        		end if
%>
					...
					<tr>
						...
						<td style="text-align: left;" colspan="2" class="corp-list">
							<ul>
<%
	For Each Entry In objDictionary
		...
		For Each szOwnerTmp2 In szOwners
			if Entry = szOwnerTmp2 then
				r_szSelected		= "checked"
			end if
		Next

		Response.Write("<li><label><input name=""Owner"" type=""checkbox"" value=""" + Entry + """ " + r_szSelected + " />(" + Entry + ")" + Replace(objDictionary(Entry), "'", "") + "</label></li>")
	Next
%>
							</ul>
							<script type="text/javascript">
