...
<%
	'02-May2005: 權限檢查
	if Session.Contents("GroupType@TPEINS01") < 0 then
...
<!------------------------列表----------------------------------->
<form name="form" method="post" action="FOfun02c.asp" OnKeyDown="CheckHotKey()">
<table width="100%" height=""100%"">
    ...
    <tr>
        <td align="center">
            <br>
            <hr>
            <input name="SendPrint" type=submit style="border-style: outset; border-width: 2" value="列印" OnKeyDown="PrintByKeyPress()" OnMouseUp=""Print()">
        </td>
    </tr>
</table>
