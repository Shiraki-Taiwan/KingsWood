...
function Add()
{
    if (checkform())
    {
        document.form.action="VOfun03b.asp";
...
function Search()
{
    document.form.action="VOfun03a.asp?Status=Search";
	document.form.submit();
}
...
function Delete()
{
    if (document.form.Status.value == "Modify") // 只有在Modify的狀況下才能修改或刪除
    {
    	...
    	{
    		document.form.action="VOfun03b.asp?Status=Delete";
    	    document.form.submit();
    	}
    }
}
...
function Reset()
{
	...
	document.form.action="VOfun03a.asp?Status=Add";
	document.form.submit();
}
