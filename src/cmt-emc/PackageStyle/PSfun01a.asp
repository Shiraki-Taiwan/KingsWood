...
<head>
	...
	<script type="text/javascript" src="PSfun01.js"></script>
</head>
...
<%
    ...
    if szStatus = "Modify" then
        sql = "select * from PackageStyle where ID = '" + szID + "'"
...
<form name="form" method="post" action="PSfun01b.asp" onsubmit=" javascript: return checkform();" OnKeyDown="CheckHotKey()">
            ...
            <table cellspacing=0 cellpadding=0 width="100%" border=0>
                <tbody> 
                    <tr bgcolor=#3366cc > 
                        ...
                        <td align=middle width="100%" ><div align="center"><font color="#FFFFFF" >包裝方式設定</font></div></td>
                                ...
                                <tbody>
	                                <tr> 
                                        ...
                                        <td align=left bgcolor=#C9E0F8 height="2" width="20%"> 
                                            <input type="text" name="ID" size="10" maxlength="10" value="<%=szIDTmp%>" onfocus=SelectText(0) OnKeyDown="ChangeFocus(1)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                        </td>
                                        <td align=right bgcolor=#C9E0F8 height="2" width="15%">名　　稱：</td>
                                        <td align=left bgcolor=#C9E0F8 height="2" width="35%"> 
                                            <input type="text" name="Name" size="20" maxlength="20" value="<%=szNameTmp%>" onfocus=SelectText(1) OnKeyDown="ChangeFocus(2)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                        </td>
                                    </tr>
                                </tbody> 
                            </table>
...
<table cellspacing=0 cellpadding=0 width="100%" border="0" align="center" >
    ...
    <tr> 
        <td > 
            ...
            %>
                <tr align="center"> 
                    <td width="20%" bgcolor=#C9E0F8 align="left"><a href="PSfun01a.asp?Status=Modify&ID=<%= rs("ID") %>"><%= rs("ID") %><a/></td>
                    <td width="80%" bgcolor=#C9E0F8 align="left"><a href="PSfun01a.asp?Status=Modify&ID=<%= rs("ID") %>"><%= rs("Name") %><a/></td>
                </tr>
            <%
                    rs.movenext
                wend
