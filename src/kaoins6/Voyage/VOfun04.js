...
function Add()
{
    if (checkform())
    {
        document.form.action="VOfun04b.asp";
...
function Search()
{
    document.form.action="VOfun04a.asp?Status=Search";
    document.form.submit();
}
...
function Delete()
{
    if (document.form.Status.value == "Modify") // 只有在Modify的狀況下才能修改或刪除
    {
    	...
    	{
    		document.form.action="VOfun04b.asp?Status=Delete";
    	    document.form.submit();
    	}
    }    
}
...
function Close()
{
    document.form.action="VOfun04b.asp?Status=Close";
    document.form.submit();
}
...
function Reset()
{
	...
	document.form.action="VOfun04a.asp?Status=Add";
	document.form.submit();    
}
...
function OnSerialNum()
{
    if (CheckKeyCode(KEY_CODE_ENTER)) // Check if press "Enter"
    {
        ...
        {
            document.form.action="VOfun04c.asp?SerialNum=" + document.form.SerialNum.value;
	        document.form.submit();   
	    }
	    else
	    {
