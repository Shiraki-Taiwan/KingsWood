...
function CheckKeyCode(aKeyCode) {
    ...
    var code = (window.NS) ? event.which : event.keyCode;
    return (code == aKeyCode);
...
function CheckHotKey() {
    ...
    else if (event.ctrlKey && code == KEY_CODE_9) {
        // CTRL + 9
        // else if (code == KEY_CODE_F9) // F9
        // 倉單資料查詢
        location.href = "../FaxService/FSfun03a.asp";
    }
    else if (event.ctrlKey && code == KEY_CODE_Q) {
        // CTRL + Q
        // else if (code == KEY_CODE_F12) // F12
        // 主選單
        location.href = "../GlobalSet/MainMenu.asp";
    }
