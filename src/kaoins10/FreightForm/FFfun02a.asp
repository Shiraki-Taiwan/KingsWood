...
<head>
	...
	<title>進倉單資料查詢/修改/核定</title>
	<!-- #include file = ../head_bundle.html -->
	<script type="text/javascript" src="FFfun02a.js"></script>
</head>
...
%>
<form name="form" method="post" action="FFfun02b.asp" onsubmit=" javascript: return checkform();"  OnKeyDown="CheckHotKey()">
        ...
        <table cellspacing=0 cellpadding=0 width="100%" border=0>
            <tbody> 
                <tr bgcolor=#3366cc > 
                    ...
                    <td align=middle width="100%" ><div align="center"><font color="#FFFFFF" >進倉單資料查詢/修改/核定</font></div></td>
                        ...
                        <table cellspacing=0 cellpadding=0 width="100%" bgcolor=#ebebeb border=0 height="38">
                            <tbody>                        
        	                    ...
        	                    <tr>
                                    ...
                                    <td align=left bgcolor=#C9E0F8 height="2" width="31%">
                                        <input type="text" name="VesselName" size="30" maxlength="22" value="<%=szVesselName%>" onfocus=SelectText(1) OnKeyDown="ChangeFocus(2)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                    </td>   
                                    <td align=right bgcolor=#C9E0F8 height="2" width="17%">航　次：</td>
                                    <td align=left bgcolor=#C9E0F8 height="2" width="31%"> 
                                        <input type="text" name="VesselNo" size="8" maxlength="10" value="<%=szVesselNo %>" onfocus=SelectText(2) OnKeyDown="ChangeFocus(3)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                    </td>      
                                </tr>
                                ...
                                <tr> 
                                    ...
                                    <td align=left bgcolor=#C9E0F8 height="2"> 
                                        <input type="text" name="Owner" size="8" maxlength="15" value="<%=szOwner%>" onfocus=SelectText(3) OnKeyDown="ChangeFocus(4)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                    </td>
                                    <td align=right bgcolor=#C9E0F8 height="2">船　掛：</td>
                                    <td align=left bgcolor=#C9E0F8 height="2"> 
                                        <input type="text" name="CheckInID" size="8" maxlength="20" value="<%=szCheckInID %>" onfocus=SelectText(4) OnKeyDown="ChangeFocus(5)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">
                                    </td>
                                </tr>
                                <tr>
                                    <td align=right bgcolor=#C9E0F8 height="2">結關日：</td>
                                    <td align=left bgcolor=#C9E0F8 height="2"> 
                                        <input type="text" name="Year" size="1" maxlength="4" value="<%=szYear%>" onfocus=SelectText(5) OnKeyDown="ChangeFocus(6)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">年
                                        <input type="text" name="Month" size="1" maxlength="2"  onfocus=SelectText(6) onblur=CheckMonth() value="<%=szMonth%>" OnKeyDown="ChangeFocus(7)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">月
                                        <input type="text" name="Day" size="1" maxlength="2"  onfocus=SelectText(7) onblur=CheckDay() value="<%=szDay%>" OnKeyDown="ChangeFocus(8)" onfocusin="SetFocusStyle(this, true, false)" onfocusout="SetFocusStyle(this, false, false)">日                
                                    </td>
...
<table cellspacing=0 cellpadding=0 width="100%" border="0" align="center" >
    ...
    <tr> 
        <td > 
            ...
            %>
                <tr align="center"> 
                    <td width="6%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%=nSerialNum%></a></td>
                    <td width="24%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%=rs("VesselName")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%= rs("VesselNo")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%=rs("Owner")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%= rs("CheckInID")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%= rs("Date")%></a></td>
                    <%
                        dim szLineName
                    ...
                    %>
                    <td width="10%" bgcolor=#C9E0F8 align="left"><a href="FFfun02b.asp?Status=FirstLoad&VesselListID=<%= rs("ID") %>&SerialNum=<%=nSerialNum%>"><%= szLineName%></a></td>
                </tr>
            <%
                    szLineName = ""
