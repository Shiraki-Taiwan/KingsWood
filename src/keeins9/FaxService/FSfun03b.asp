...
<head>
	...
	<script type="text/javascript" src="FSfun03b.js"></script>
</head>
...
<form name="form" method="post" action="FSfun03c.asp" onsubmit=" javascript: return checkform();"  OnKeyDown="CheckHotKey()">
                ...
                <tr>
                    <td height="24"> 
                        <table cellspacing=0 cellpadding=0 width="100%" bgcolor=#ebebeb border=0 height="38">
                            <tbody>                        
        	                    <tr>
                                    <td align=right bgcolor=#C9E0F8 height="2" width="17%">表單種類：</td>
                                    <td align=left bgcolor=#C9E0F8 height="2" width="31%">
                                    <%
                                        if szReportType = 1 then
                                            response.write "總表查詢"
                                        elseif szReportType = 2 then
                                            response.write "尺寸資料查詢"
                                        end if
                                    %>
                                    </td>   
        	                    ...
        	                    <tr>
                                    <td align=right bgcolor=#C9E0F8 height="2">船　　名：</td>
...
%>
<input type="hidden" name="ReportType" value="<%=szReportType%>">  <!--表單種類-->
<A name=D></A>
<table cellspacing=0 cellpadding=0 width="100%" border="0" align="center" >
    <tr> 
        <td > 
    ...
    <tr> 
        <td > 
            ...
            %>
                <tr align="center"> 
                    <td width="6%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%=nSerialNum%></a></td>
                    <td width="24%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%=rs("VesselName")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%= rs("VesselNo")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%=rs("Owner")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%= rs("CheckInID")%></a></td>
                    <td width="15%" bgcolor=#C9E0F8 align="left"><a href="FSfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%= rs("Date")%></a></td>
                    <%
                        dim szLineName
                    ...
                    %>
                    <td width="10%" bgcolor=#C9E0F8 align="left"><a href="FFfun03c.asp?ReportType=<%=szReportType%>&VesselListID=<%= rs("ID") %>&VesselLine=<%=rs("VesselLine")%>&SerialNum=<%=nSerialNum%>"><%= szLineName%></a></td>
                </tr>
            <%
                    rs.movenext
                    szLineName = ""
