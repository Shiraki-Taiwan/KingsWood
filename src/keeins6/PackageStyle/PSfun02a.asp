...
<head>
	...
	<title>包裝方式列印查詢</title>
	<!-- #include file = ../head_bundle.html -->
	<script type="text/javascript" src="PSfun02.js"></script>
</head>
...
<form name="form" method="post" action="PSfun02b.asp" OnKeyDown="CheckHotKey()">
            ...
            <table cellspacing=0 cellpadding=0 width="100%" border=0>
                <tbody> 
                    <tr bgcolor=#3366cc > 
                        ...
                        <td align=middle width="100%" ><div align="center"><font color="#FFFFFF" >包裝方式列印查詢</font></div></td>
                    ...
                    <tr>
                        <td height="24"> 
                            <table cellspacing=0 cellpadding=0 width="100%" bgcolor=#ebebeb border=0 height="38">
                                <tbody>
	                                <tr> 
                                        <td align=right bgcolor=#cccccc height="2" width="30%">編　　號：</td>
                                        <td align=left bgcolor=#cccccc height="2" width="20%"> 
                                            <input type="text" name="ID" size="10" maxlength="10" value="" OnKeyDown="ChangeFocus(1)">
                                        </td>
                                        <td align=right bgcolor=#cccccc height="2" width="15%">名　　稱：</td>
                                        <td align=left bgcolor=#cccccc height="2" width="35%"> 
                                            <input type="text" name="Name" size="20" maxlength="20" value="" OnKeyDown="ChangeFocus(2)">
                                        </td>
                                    </tr>
                                </tbody> 
                            </table>
