...
<head>
	...
	<title>船名資料列印查詢</title>
	<!-- #include file = ../head_bundle.html -->
	<script type="text/javascript" src="SNfun02.js"></script>
</head>
...
<form name="form" method="post" action="SNfun02b.asp" OnKeyDown="CheckHotKey()">
        ...
        <table cellspacing=0 cellpadding=0 width="100%" border=0>
            <tbody> 
                <tr bgcolor=#3366cc > 
                    ...
                    <td align=middle width="100%" ><div align="center"><font color="#FFFFFF" >船名資料列印查詢</font></div></td>
                            ...
                            <tbody>
	                            <tr> 
                                    ...
                                    <td align=left bgcolor=#cccccc height="2" width="55%"> 
                                        <input type="text" name="ID" size="10" maxlength="10" value="<%=szIDTmp%>" OnKeyDown="ChangeFocus(1)">
                                    </td>
                                </tr>
                                <tr>
                                    <td align=right bgcolor=#cccccc height="2">船　名：</td>
                                    <td align=left bgcolor=#cccccc height="2"> 
                                        <input type="text" name="Name" size="20" maxlength="20" value="<%=szNameTmp%>" OnKeyDown="ChangeFocus(2)">
                                    </td>
                                </tr>
                                <tr>
                                    <td align=right bgcolor=#cccccc height="2" >船公司：</td>
                                    <td align=left bgcolor=#cccccc height="2" > 
                                        <input type="text" name="Owner" size="20" maxlength="20" value="<%=szOwnerTmp%>" OnKeyDown="ChangeFocus(3)">
                                    </td>
                                </tr>
                            </tbody> 
                        </table>
